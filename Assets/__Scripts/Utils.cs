...
public class Utils : MonoBehaviour {
	...
	// Create bounds that encapsulate the two Bounds passed in
	...
	public static void SetCameraBounds(Camera cam = null){
		...
		if (cam == null)
			cam = Camera.main;
		// This makes a couple of important assumptions aboud the camera:
		// The Camera is Orthographic
		// The camera is at a rotation of R:[0,0,0]
